...
def _preponderance_section(r: DetailedReport) -> str:
    ...
    return (
        ...
        'yoga row leans only by its encoded kind (raja/dhana favourable, arishta adverse); '
        'lunar and other kinds are deliberately left neutral &mdash; a refusal to encode '
        'per-yoga leans, under-claiming by design. Bhava-Bala rank is shown as a magnitude '
        'and carries no direction.</p>'
        '<div class="tablewrap"><table class="grid"><thead><tr><th>house</th><th>verdict</th>'
