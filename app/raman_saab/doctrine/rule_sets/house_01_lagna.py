...
Lord-of-the-1st in the 12 houses, encoded from the methodology table in
`docs/raman_saab/methodology/house_01_lagna.md` (section "Lord of the 1st
in the 12 Houses"). Each row cites a HTJAH-I span; `source.line` is set to
the FIRST line of that span, which is the first line of Raman's text for
that placement. Fortified vs. afflicted readings follow his general rule
(HTJAH-I:1003–1007) that evil aspect/weakness inverts or worsens the base
reading; where the methodology records no separate afflicted clause the
...
RULES: Final[tuple[RuleRecord, ...]] = (
    ...
    # ── Planets in the 1st House (HTJAH-I:1499–1562) ──────────────────────────
    RuleRecord(
