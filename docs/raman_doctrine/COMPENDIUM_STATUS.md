...
**1,085 rule records across 10 of B. V. Raman's books**, every quote verbatim-verified against the pinned OCR (`quote_verified` = true for all), every executable antecedent compiling through the DSL engine.

## By book

| key | title | records |
|---|---|---:|
| `hpa` | Hindu Predictive Astrology | 578 |
